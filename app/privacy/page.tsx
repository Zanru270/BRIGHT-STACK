...
const sections = [
  {
    ...
    content:
      "Zanru Kruger, trading as Bright Stack, Johannesburg, Gauteng, South Africa. Contact: zanru2@icloud.com",
  },
  {
...
export default function PrivacyPage() {
  return (
    <LegalPageLayout
      ...
      intro="Bright Stack, operated by Zanru Kruger and based in Johannesburg, South Africa, is committed to protecting your personal information in compliance with the Protection of Personal Information Act 4 of 2013 (POPIA)."
      sections={sections}
    />
  );
}
