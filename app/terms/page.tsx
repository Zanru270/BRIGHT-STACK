...
export const metadata: Metadata = {
  ...
  description:
    "Terms and Conditions governing all software development services provided by Bright Stack, operated by Zanru Kruger, Johannesburg, South Africa.",
};
...
const sections = [
  ...
  },
  {
    title: "Contact",
    content:
      "For questions regarding these Terms: zanru2@icloud.com",
  },
];
...
export default function TermsPage() {
  return (
    <LegalPageLayout
      ...
      intro={`These Terms and Conditions ("Terms") govern all services provided by Bright Stack, a software development studio based in Johannesburg, South Africa, operated by Zanru Kruger trading as Bright Stack. By engaging our services, you ("the Client") agree to be bound by these Terms.`}
      sections={sections}
    />
  );
}
