...
export default function RefundPage() {
  return (
    <LegalPageLayout
      ...
      intro="This Refund and Cancellation Policy applies to all software development services provided by Bright Stack, operated by Zanru Kruger, Johannesburg, South Africa, and is compliant with the Consumer Protection Act 68 of 2008 (CPA)."
      sections={sections}
    />
  );
}
